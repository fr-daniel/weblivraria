...
WebLivraria.UploadFoto = (function() {
	...
	function UploadFoto() {
		...
		this.htmlFotoTemplate = $('#foto-upload').html();
		this.template = Handlebars.compile(this.htmlFotoTemplate);
		
		this.containerFotoCerveja = $('.js-container-foto-upload');
...
$(function() {
	var uploadFoto = new WebLivraria.UploadFoto();
	uploadFoto.iniciar();
});